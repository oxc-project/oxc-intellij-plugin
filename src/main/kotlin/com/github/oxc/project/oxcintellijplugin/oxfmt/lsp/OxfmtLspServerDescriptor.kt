...
class OxfmtLspServerDescriptor(
    ...
    private val targetRun: OxcTargetRun = run {
        ...
        val builder = OxcTargetRunBuilder(project).getBuilder(settings.configurationMode,
            executable).setWorkingDirectory(root.path).addParameters(executableParameters)
